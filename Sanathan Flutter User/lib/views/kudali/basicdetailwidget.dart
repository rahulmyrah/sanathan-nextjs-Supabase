...
class BasicDetailsWidget extends StatelessWidget {
  ...
  const BasicDetailsWidget({this.basicDetails, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String?>> ghatakDetails = [
      ...
      {
        'label': 'Nakshatra',
        'value': basicDetails?.planetDetails?.response?.nakshatra,
      },
      {
        'label': 'Nakshatra Pada',
        'value': basicDetails?.planetDetails?.response?.nakshatraPada
            .toString(),
      },
            ...
            Container(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return Container(
                    color: isEven
                        ? Get.theme.primaryColor.withAlpha((255 * 0.1).toInt())
