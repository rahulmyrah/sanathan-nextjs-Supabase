...
- [ ] Implement Authenticated User & Wallet APIs
  - [ ] Lazy authentication JWT validation filter and middleware
  - [ ] Wallet credit balance recharge endpoint
  - [ ] Razorpay webhook payment controller & ledger transaction writer
  - [ ] Stripe webhook payment controller & ledger transaction writer
  - [ ] Cashfree webhook payment controller & ledger transaction writer
  - [ ] USD-to-INR conversions factor config controller
